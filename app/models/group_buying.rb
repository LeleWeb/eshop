class GroupBuying < ApplicationRecord
  ...
  validates :current_number, numericality: { only_integer: true, greater_than: 0 }
  validates :limit_min, numericality: { greater_than_or_equal_to: 0 }
  validates :target_amount,  :limit_max, numericality: { greater_than: 0 }
